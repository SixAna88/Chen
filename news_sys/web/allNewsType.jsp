...
<div id="message">
    ...
    <table class="layui-table">
        ...
        <tbody>
        <tr>
            <td><input type="checkbox" name="check" value="<%= newsType.getTypeId()%>"/></td>
            <td><%= newsType.getTypeId()%>
            </td>
            <td><%= newsType.getTypeName()%>
            </td>
            <td><%= newsType.getCreateDate()%>
            </td>
            <td>
                <a href="/updateNewsType.jsp?typeId=<%=newsType.getTypeId()%>" class="layui-btn layui-btn-sm layui-btn-normal">修改</a>
                <a href="/NewsTypeBean?action=delete&TypeId=<%=newsType.getTypeId()%>" class="layui-btn layui-btn-sm layui-btn-danger"
                   onClick="deleteNewsType()">删除</a>
            </td>
        </tr>
        <%
            }

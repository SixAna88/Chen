...
<div id="message">
    <a href="index.jsp" type="button" class="layui-btn layui-btn-warm">主页</a>
    <!-- 打开弹窗按钮 -->
...
<%--    </fieldset>--%>
    ...
    <form action="/NewsInfoBean?action=add" method="post">
        ...
        <table class="layui-table">
            ...
            <tbody>
            <tr>
                <td><textarea style="width: 80px" type="text" name="newsId" value=""></textarea>
                </td>
                <td><textarea style="width: 80px" type="text" name="newsTitle" value=""></textarea>
                </td>
                <td><textarea style="width: 60px" type="text" name="newsContent" value=""></textarea>
                </td>
                <td><textarea style="width: 80px" type="text" name="typeId" value=""></textarea>
                </td>
                <td><input style="width: 130px" type="date" name="newsPublish" value="">
                </td>
                <td><textarea style="width: 160px" type="text" name="newsSource" value=""></textarea>
                </td>
                <td><textarea style="width: 100px" type="text" name="remark" value=""></textarea>
                </td>
                <td>

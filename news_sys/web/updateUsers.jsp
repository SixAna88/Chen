...
<div id="message">
    ...
    <form action="/updateUsers.users" method="post">
        <table class="layui-table">
            ...
            %>
            <tr>
                <td><input style="width: 80px" type="hidden" name="userId"
                           value="<%= users.getUserId()%>"><%= users.getUserId()%>
                </td>
                <td><input style="width: 80px" type="text" name="username" value="<%= users.getUsername()%>">
                </td>
                <td><input style="width: 80px" type="text" name="password" value="<%= users.getPassword()%>">
                </td>
                <td><input style="width: 80px" type="text" name="userPhone" value="<%= users.getUserPhone()%>">
                </td>
                <td><input style="width: 60px" type="text" name="userAge" value="<%= users.getUserAge()%>">
                </td>
                <td><input style="width: 130px" type="date" name="birth" required lay-verify="required"
                           placeholder="请输入出生日期" value="<%= users.getBirth()%>">
                </td>
                <td><textarea style="width: 200px; height: 100px" type="text" name="remark"
                              value="<%= users.getRemark()%>"><%= users.getRemark()%></textarea>
                </td>
                <td>
